                ...
                <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                    <div class="overflow-hidden shadow ring-1 ring-black/5 sm:rounded-lg">
                        ...
                        >
                            ...
                            <Column field="companyName" header="Ipo Name" sortable></Column>
                            <Column field="symbol" header="Ipo Symbol" sortable></Column>
                            <Column field="isin" header="ISIN" sortable></Column>
                            <Column field="tradinglot" header="Lot Size" sortable></Column>
                            <Column field="opendate" header="Start date" sortable></Column>
                            <Column field="closedate" header="End Date" sortable></Column>
                            <Column field="cuttoff" header="Cutoff Price" sortable></Column>
